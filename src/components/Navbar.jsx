  ...
  return (
    <div className='fixed top-0 left-0 w-full bg-opacity-70 backdrop-blur-md z-50'>
        ...
        text-xl items-center px-12 h-20'>
            ...
            <a href="">Tofiquel Alam</a>

            <ul className='hidden md:flex gap-12 z-10 cursor-pointer'>
                <li><Link to="skills" smooth={true} offset={-100} duration={500}>Skill</Link></li>
            ...
            >
                <ul className='font-semibold text-4xl space-y-8 mt-24 text-center'>
                    <li><Link to="skills" onClick={closeNav} smooth={true} offset={-100} duration={500}>Skill</Link></li>
                    <li><Link to="portfolio" onClick={closeNav} smooth={true} offset={-100} duration={500}>Portfolio</Link></li>
                    <li><Link to="experience" onClick={closeNav} smooth={true} offset={-100} duration={500}>Experience</Link></li>
                    <li><Link to="contact" onClick={closeNav} smooth={true} offset={-100} duration={500}>Contact</Link></li>
                </ul>
